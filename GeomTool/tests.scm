...
(define test-union-SLSL-4		;two boundeds, result = 2 boundeds, they're disjoint
   ...
   (lambda ()
     (let ((L1 (factory-make-poly '((0 0) (1 0) (1 1) (0 1) (0 0))))
       ...
       (assert-yell (gt-segmentlist2-almostequal (gt-segmentlist2-simplify (gt-region2-list (gt-set2-region S 0) 0)) L1) "test-union-SLSL-4.4")
       (assert-yell (gt-segmentlist2-almostequal (gt-segmentlist2-simplify (gt-region2-list (gt-set2-region S 1) 0)) L2) "test-union-SLSL-4.5")
       )))
...
(define test-union-SLSL-6 		;one hole, one bounded, result = negative donut
  (lambda ()
     (let ((L1 (factory-make-poly '((0 0) (0 3) (3 3) (3 0) (0 0))))
       ...
       (assert-yell (equal? (gt-region2-numlists (gt-set2-region S 0)) 2) "test-union-SLSL-6.2")
       (assert-yell (equal? (gt-region2-numlists (gt-set2-region S 1)) 1) "test-union-SLSL-6.3")
       (assert-yell (equal? "UNBOUNDED" (gt-segmentlist2-gettype (gt-region2-list (gt-set2-region S 0) 0))) "test-union-SLSL-6.4")
       (assert-yell (gt-segmentlist2-almostequal (gt-segmentlist2-simplify (gt-region2-list (gt-set2-region S 0) 1)) L1) "test-union-SLSL-6.5")
       (assert-yell (gt-segmentlist2-almostequal (gt-segmentlist2-simplify (gt-region2-list (gt-set2-region S 1) 0)) L2) "test-union-SLSL-6.6")
       )))
